...
#以降を飛ばしても問題は発生した
            ...
            if self.draggable:
                ...
                self.alternate = ShowAlternateMenu(
                    [
                        ...
                        ("edit: xpos {}".format(xpos), [Function(edit_value, self.x_changed, is_wide_range((tag, layer, "xpos")), xpos, "xpos" in force_plus, current_time), Function(change_time, current_time)]),
                        ("edit: ypos {}".format(ypos), [Function(edit_value, self.y_changed, is_wide_range((tag, layer, "ypos")), ypos, "ypos" in force_plus, current_time), Function(change_time, current_time)]),
                        ("edit: zpos {}".format(zpos), [Function(edit_value, self.z_changed, is_wide_range((tag, layer, "zpos")), zpos, "zpos" in force_plus, current_time), Function(change_time, current_time)]),
                        ("edit: rotate {}".format(rotate), [Function(edit_value, self.r_changed, is_wide_range((tag, layer, "rotate")), rotate, "rotate" in force_plus, current_time), Function(change_time, current_time)])
                    ],
                    style_prefix="_viewers_alternate_menu"
                )
        ...
        def __init__(self, scene_num):
            ...
            if self.draggable:
                ...
                self.alternate = ShowAlternateMenu(
                    [
                        ("camera", NullAction()),
                        ("edit: xpos {}".format(xpos), [Function(edit_value, self.x_changed, is_wide_range("xpos"), xpos, "xpos" in force_plus, current_time), Function(change_time, current_time)]),
                        ("edit: ypos {}".format(ypos), [Function(edit_value, self.y_changed, is_wide_range("ypos"), ypos, "ypos" in force_plus, current_time), Function(change_time, current_time)]),
                        ("edit: zpos {}".format(zpos), [Function(edit_value, self.z_changed, is_wide_range("zpos"), zpos, "zpos" in force_plus, current_time), Function(change_time, current_time)]),
                        ("edit: rotate {}".format(rotate), [Function(edit_value, self.r_changed, is_wide_range("rotate"), rotate, "rotate" in force_plus, current_time), Function(change_time, current_time)])
                    ],
                    style_prefix="_viewers_alternate_menu"
                )
    ...
    def generate_sound_menu(channel, time):
        ...
        button_list = [
            ...
            (_("edit time: {}".format(time)), Function(edit_move_keyframe, keys=channel, old=time, is_sound=True)),
            (_("remove"), Function(remove_keyframe, remove_time=time, key=channel, is_sound=True)),
            ]
        return button_list
