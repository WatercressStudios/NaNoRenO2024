...
init python:
    ...
    MapEmote('oph e_embarrassed', 'oph engaged base md_default ed_default brow_sad blush sweat')
    ...
    MapEmote('oph e_sad', 'oph engaged base md_sad ed_sad brow_sad')
    MapEmote('oph e_sad_mo', 'oph engaged base mdo_default ed_sad brow_sad')
    MapEmote('oph e_sad_smile', 'oph engaged base md_smile ed_sad brow_sad')
    ...
    MapEmote('fre pout', 'fre default base md_pout ed_sad brow_sad')
